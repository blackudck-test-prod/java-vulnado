...
The docker network created by `docker-compose` maps pretty well to a multi-tier architectture where a web server is publictly available and there are other network resources like a database and internal site that are not publicly available.
